...
if selected_value == "I. Introduction":
    ...
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown1 = st.checkbox("Show analysis 1")
    # Show Markdown text or not depending on the checked box
    if show_markdown1:
    ...
    fig = px.histogram(stress_data_2023, x='STRESS_SCORE', nbins=20, title='Histogram of Stress Scores')
    # Update axis labels
    fig.update_xaxes(title='Stress Score')
    fig.update_yaxes(title='Frequency')
    # Render the interactive Plotly chart
    st.plotly_chart(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown2 = st.checkbox("Show analysis 2")
    # Show Markdown text or not depending on the checked box
    if show_markdown2:
        st.markdown("""With the histogram, we notice that there are only 10 values between 0 and 4. These values can represent the times when I was the most stressed during this year, just as they can represent times when I was not wearing my watch. 
        \nWhen I am not wearing my watch, the score is automatically set to 0.
        \nApart from these values we notice that the rest of the time, my stress score is between 55 and 94. With most often a score between 70 and 84. These values are much closer to 100 than to 0, which again confirms the previous interpretation.""")
    ...
    st.pyplot()
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown3 = st.checkbox("Show analysis 3")
    # Show Markdown text or not depending on the checked box
    if show_markdown3:
    ...
    st.pyplot()
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown4 = st.checkbox("Show analysis 4")
    # Show Markdown text or not depending on the checked box
    if show_markdown4:
    ...
    stress_data_2023['Month'] = stress_data_2023['Month'].apply(lambda x: calendar.month_name[x])
    ...
    for month, stress_score in zip(monthly_avg_stress.index, monthly_avg_stress.values):
        plt.text(month, stress_score, str(round(stress_score, 2)), ha='center', va='bottom')
    st.pyplot()
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown5 = st.checkbox("Show analysis 5")
    # Show Markdown text or not depending on the checked box
    if show_markdown5:
    ...
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown6 = st.checkbox("Show analysis 6")
    # Show Markdown text or not depending on the checked box
    if show_markdown6:
    ...
    # Create a histogram using Plotly
    fig = px.histogram(temperature_data, x='nightly_temperature', title='Distribution of Nightly Temperature', nbins=20)
    # Customize the figure
    fig.update_traces(marker_color='skyblue', selector=dict(type='histogram'))
    fig.update_xaxes(title='Nightly Temperature')
    fig.update_yaxes(title='Frequency')
    # Render the interactive Plotly chart
    st.plotly_chart(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown7 = st.checkbox("Show analysis 7")
    # Show Markdown text or not depending on the checked box
    if show_markdown7:
    ...
    st.pyplot()
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown8 = st.checkbox("Show analysis 8")
    # Show Markdown text or not depending on the checked box
    if show_markdown8:
    ...
    st.pyplot()
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown9 = st.checkbox("Show analysis 9")
    # Show Markdown text or not depending on the checked box
    if show_markdown9:
    ...
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown10 = st.checkbox("Show analysis 10")
    # Show Markdown text or not depending on the checked box
    if show_markdown10:
    ...
    # Create a histogram using Plotly
    fig = px.histogram(hrv_data, x='rmssd', title='Distribution of RMSSD', nbins=20)
    # Customize the figure
    fig.update_traces(marker_color='skyblue', selector=dict(type='histogram'))
    fig.update_xaxes(title='RMSSD')
    fig.update_yaxes(title='Frequency')
    # Render the interactive Plotly chart
    st.plotly_chart(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown11 = st.checkbox("Show analysis 11")
    # Show Markdown text or not depending on the checked box
    if show_markdown11:
    ...
    hrv_data['timestamp'] = pd.to_datetime(hrv_data['timestamp'])
    ...
    fig = px.line(hrv_data, x='timestamp', y='nremhr', title='NREM HR Over Time')
    # Customize the graph
    fig.update_xaxes(title='Month')
    fig.update_yaxes(title='NREM HR')
    # Display the Plotly figure in Streamlit
    st.plotly_chart(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown12 = st.checkbox("Show analysis 12")
    # Show Markdown text or not depending on the checked box
    if show_markdown12:
    ...
    st.pyplot()
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown13 = st.checkbox("Show analysis 13")
    # Show Markdown text or not depending on the checked box
    if show_markdown13:
    ...
    st.pyplot(plt)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown14 = st.checkbox("Show analysis 14")
    # Show Markdown text or not depending on the checked box
    if show_markdown14:
    ...
    # Create a Plotly figure
    fig = px.line(df_hrv_details, x='timestamp', y='rmssd', title='Line Plot of RMSSD Over Time')
    # Customize the graph
    ...
    st.plotly_chart(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown15 = st.checkbox("Show analysis 15")
    # Show Markdown text or not depending on the checked box
    if show_markdown15:
    ...
    st.pyplot(plt)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown16 = st.checkbox("Show analysis 16")
    # Show Markdown text or not depending on the checked box
    if show_markdown16:
    ...
    st.pyplot(plt)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown17 = st.checkbox("Show analysis 17")
    # Show Markdown text or not depending on the checked box
    if show_markdown17:
    ...
    fig.update_xaxes(title_text='Bucket Values', showticklabels=False)
    fig.update_yaxes(title='Frequency')
    st.write(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown18 = st.checkbox("Show analysis 18")
    # Show Markdown text or not depending on the checked box
    if show_markdown18:
    ...
    st.write(summary)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown19 = st.checkbox("Show analysis 19")
    # Show Markdown text or not depending on the checked box
    if show_markdown19:
        st.markdown("""We have 252 values.
    ...
    # Create a histogram using Plotly
    fig = px.histogram(respiratory_rate_data, x='daily_respiratory_rate', title='Histogram of Daily Respiratory Rate', nbins=20)
    # Customize the figure
    fig.update_traces(marker_color='skyblue', selector=dict(type='histogram'))
    fig.update_xaxes(title='Daily Respiratory Rate')
    fig.update_yaxes(title='Frequency')
    # Render the interactive Plotly chart
    st.plotly_chart(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown20 = st.checkbox("Show analysis 20")
    # Show Markdown text or not depending on the checked box
    if show_markdown20:
        st.markdown("""The histogram confirms the previous interpretation.
        \nWe note that the minimum and maximum were reached during peaks and are exceptional values. Generally speaking, the values fluctuate between 15 and 17.9.""")
    ...
    st.pyplot(plt)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown21 = st.checkbox("Show analysis 21")
    # Show Markdown text or not depending on the checked box
    if show_markdown21:
    ...
    st.pyplot(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown22 = st.checkbox("Show analysis 22")
    # Show Markdown text or not depending on the checked box
    if show_markdown22:
    ...
    st.pyplot(plt)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown23 = st.checkbox("Show analysis 23")
    # Show Markdown text or not depending on the checked box
    if show_markdown23:
    ...
    st.plotly_chart(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown24 = st.checkbox("Show analysis 24")
    # Show Markdown text or not depending on the checked box
    if show_markdown24:
    ...
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown25 = st.checkbox("Show analysis 25")
    # Show Markdown text or not depending on the checked box
    if show_markdown25:
    ...
    st.pyplot(fig)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown26 = st.checkbox("Show analysis 26")
    # Show Markdown text or not depending on the checked box
    if show_markdown26:
    ...
    st.pyplot(plt)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown27 = st.checkbox("Show analysis 27")
    # Show Markdown text or not depending on the checked box
    if show_markdown27:
    ...
    st.pyplot(plt)
    # Create a checkbox to enable or disable display of Markdown text
    show_markdown28 = st.checkbox("Show analysis 28")
    # Show Markdown text or not depending on the checked box
    if show_markdown28:
